...
function FijiScan(allParams, continueFlag) {
	...
	*/
	default = newArray(true, true, true, true, true, true, true);
...
function fullScan(allParams, continueFlag) {
	...
	labels = newArray("Effective Brightness/Contrast", "Threshold Levels", "Threshold Types");
	default = newArray(false, false, false);
...
function analyzeParticlesDefault(allParams, continueFlag) {
	...
	//************************
	// Advanced Threshold 2
	thresholdMethod = "RenyiEntropy"; // as opposed to "Default" or ...
	//*************************

	
	//*************************
	// Advanced Default Clone Analysis Parameters 2a
	run("Set Measurements...", "mean shape redirect=None decimal=2");
	//*************************
...
function analyzeParticlesCustomized(allParams, continueFlag) {
	...
	//************************
	// Advanced Threshold 1
	thresholdMethod = "RenyiEntropy"; // as opposed to "Default" or ...
	//*************************


	//*************************
	// Advanced User-defined Clone Analysis Parameters 1a
	run("Set Measurements...", "mean shape redirect=None decimal=2");
	//*************************
...
function checkForDuplicatesCustomized() {
	...
	//*************************
	// Advanced User-defined Clone Analysis Parameters 2b
	initialTolerancePercent = newArray(5, 5, 5, 5, 5);
	//*************************
...
function checkForDuplicatesDefault() {
	...
	//*************************
	// Advanced Default Clone Analysis Parameters 1b
	initialTolerancePercent = newArray(0, 0, 0, 0, 0);
	//*************************
...
function getAllParams() {
	...
	allParams[Cntr++] = "" + 0;			    // 0. minPixel, Minimum pixel intensity of intensity range
	allParams[Cntr++] = "" + 255;		    // 1. maxPixel, Maximum pixel intensity of intensity range
	allParams[Cntr++] = "" + 17;		    // 2. nSteps, Number of steps along intensity range. Max=255. High number=fine fractionation, low number=coarse fractionation of colour display
	allParams[Cntr++] = "" + 250;		    // 3. msDelay, Millisecond delay of fractionation steps
	allParams[Cntr++] = "" + "space";	    // 4. pauseKey, Press the <Space bar> to pause the InspectJ run
	allParams[Cntr++] = "" + 400;		    // 5. msDelayLong, Millisecond delay between different display routine steps
	allParams[Cntr++] = "" + 1;			    // 6. blackBackground, Black background
	allParams[Cntr++] = "" + 800;		    // 7. keyDelay, Millisecond delay after detection of a key hit (i.e. pressing key <Shift>) to avoid duplication 
	allParams[Cntr++] = "" + "false";	    // 8. customizeScansFlag, Set "true" to customize, which display routines to perform. Set "false" to run all automatically.
	allParams[Cntr++] = "" + 10;		    // 9. minSize, Minimum size (area in pixel^2) for particle analysis, i.e. clone analysis
	allParams[Cntr++] = "" + 100000;	    // 10. maxSize, Maximum size (area in pixel^2) for particle analysis, i.e. clone analysis
	allParams[Cntr++] = "" + 0.00;		   // 11. minCirc, Minimum circularity for particle analysis, i.e. clone analysis
	allParams[Cntr++] = "" + 1.00;		   // 12. maxCirc, Maximum circularity for particle analysis, i.e. clone analysis
	allParams[Cntr++] = "" + "shift";	   // 13. stopKey, Press the <Shift> key to stop the InspectJ run
	allParams[Cntr++] = "" + "false";	   // 14. FijiFeaturesScanFlag, Set "true" to run additional Fiji features display routines. Set "false" not to run them at all. FIJI Life-Line version, 2015 December 22
	allParams[Cntr++] = "" + "false";	   // 15. customizeFijiScansFlag, Set "true" to customize additional Fiji features (needs "true" in 14.). Set "false" to run all automatically. FIJI Life-Line version, 2015 December 22	
	//*************************
...
function setLUT() {
	...
	//******************************
	// Advanced Colour Regime Lookup tables
	lutPreferred = "3-3-2 RGB";
	//******************************
